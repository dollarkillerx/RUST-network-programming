...
pub trait Hello {
    fn hello_world(&self, o: ::grpc::ServerHandlerContext, req: ::grpc::ServerRequestSingle<super::hello::Req>, resp: ::grpc::ServerResponseUnarySink<super::hello::Resp>) -> ::grpc::Result<()>;
}
...
impl HelloClient {
    pub fn hello_world(&self, o: ::grpc::RequestOptions, req: super::hello::Req) -> ::grpc::SingleResponse<super::hello::Resp> {
